...
extern SEXP RMINC_anat_summary(SEXP, SEXP, SEXP);
extern SEXP RMINC_coords2ind(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_count_labels(SEXP);
extern SEXP RMINC_graph_tfce(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_graph_tfce_wqu(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_ind2coords(SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_mesh_area(SEXP, SEXP);
extern SEXP RMINC_neighbour_list(SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_rcpp_minc_apply(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP RMINC_replaceValues(SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"RMINC_anat_summary",     (DL_FUNC) &RMINC_anat_summary,      3},
  {"RMINC_coords2ind",       (DL_FUNC) &RMINC_coords2ind,        6},
  {"RMINC_count_labels",     (DL_FUNC) &RMINC_count_labels,      1},
  {"RMINC_graph_tfce",       (DL_FUNC) &RMINC_graph_tfce,        6},
  {"RMINC_graph_tfce_wqu",   (DL_FUNC) &RMINC_graph_tfce_wqu,    6},
  {"RMINC_ind2coords",       (DL_FUNC) &RMINC_ind2coords,        4},
  {"RMINC_mesh_area",        (DL_FUNC) &RMINC_mesh_area,         2},
  {"RMINC_neighbour_list",   (DL_FUNC) &RMINC_neighbour_list,    4},
  {"RMINC_rcpp_minc_apply",  (DL_FUNC) &RMINC_rcpp_minc_apply,  10},
  {"RMINC_replaceValues",    (DL_FUNC) &RMINC_replaceValues,     4},
