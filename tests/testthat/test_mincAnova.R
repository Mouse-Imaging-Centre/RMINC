...
rmincAnova = verboseRun(
  "mincAnova(voxel_left_file ~ Sex, gftest)",
  getOption("verbose")
)
...
rmincAnova = verboseRun(
  "mincAnova(voxel_left_file~Sex*Scale,gftest)",
  getOption("verbose")
)
...
rmincAnova = verboseRun(
  "mincAnova(voxel_left_file~Coil,gftest)",
  getOption("verbose")
)
...
rmincAnova = verboseRun(
  "mincAnova(voxel_left_file~Scale*Coil,gftest)",
  getOption("verbose")
)
