...
test_that("anatFDR Two Factors", {
  expect_equal(unname(rLmFDR1[1]), unname(rmincFDR[1, 2]))
  expect_equal(unname(rLmFDR1[2]), unname(rmincFDR[2, 2]))
  expect_equal(unname(rLmFDR1[3]), unname(rmincFDR[3, 2]))
  expect_equal(unname(rLmFDR2[1]), unname(rmincFDR[1, 3]))
  expect_equal(unname(rLmFDR2[2]), unname(rmincFDR[2, 3]))
  expect_equal(unname(rLmFDR2[3]), unname(rmincFDR[3, 3]))
})
...
test_that("anatFDR Interaction", {
  ...
  expect_equal(unname(rLmFDR2[2]), unname(rmincFDR[2, 3]))
  expect_equal(unname(rLmFDR2[3]), unname(rmincFDR[3, 3]))
  expect_equal(unname(rLmFDR3[1]), unname(rmincFDR[1, 4]))
  expect_equal(unname(rLmFDR3[2]), unname(rmincFDR[2, 4]))
  expect_equal(unname(rLmFDR3[3]), unname(rmincFDR[3, 4]))
  expect_equal(unname(rLmFDR4[1]), unname(rmincFDR[1, 5]))
  expect_equal(unname(rLmFDR4[2]), unname(rmincFDR[2, 5]))
  expect_equal(unname(rLmFDR4[3]), unname(rmincFDR[3, 5]))
})
...
test_that("anatFDR Three Factors Interaction", {
  ...
  expect_equal(unname(rLmFDR4[2]), unname(rmincFDR[2, 5]))
  expect_equal(unname(rLmFDR4[3]), unname(rmincFDR[3, 5]))
  expect_equal(unname(rLmFDR5[1]), unname(rmincFDR[1, 6]))
  expect_equal(unname(rLmFDR5[2]), unname(rmincFDR[2, 6]))
  expect_equal(unname(rLmFDR5[3]), unname(rmincFDR[3, 6]))
  expect_equal(unname(rLmFDR6[1]), unname(rmincFDR[1, 7]))
  expect_equal(unname(rLmFDR6[2]), unname(rmincFDR[2, 7]))
  expect_equal(unname(rLmFDR6[3]), unname(rmincFDR[3, 7]))
})
