...
AALAtlas = read.csv("/home/dcassel/resource/Atlases/AAL/AAL.csv")
verticesL = read.csv("/home/dcassel/resource/Atlases/AAL/AAL_atlas_left.txt")
verticesR = read.csv("/home/dcassel/resource/Atlases/AAL/AAL_atlas_right.txt")
