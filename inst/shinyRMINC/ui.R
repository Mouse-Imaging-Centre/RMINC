  ...
  sidebarPanel(
    ...
    conditionalPanel(
      ...
      selectInput(
        ...
        choices = c("coronal" = 2, "sagittal" = 1, "axial" = 3)
      )
    ),
    conditionalPanel(
      'input.tab == "Slice Series"',
    ...
    conditionalPanel(
      'input.tab == "Slice Series"',
      sliderInput("columns", "Number of columns", min = 1, max = 10, value = 4)
    ),
    conditionalPanel(
    ...
    conditionalPanel(
      ...
      selectInput(
        "xvar",
        "X axis on plot",
        choices = c("Adult", "Neonatal", "treatment", "sex")
      )
    ),
    conditionalPanel(
      'input.tab == "Single Slice" || input.tab == "Volumes"',
  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel(
        ...
        fluidRow(
          column(8, plotOutput("sagittalPlot", click = "click_sagittal")),
          column(4, plotOutput("graphPlot"))
        ),
